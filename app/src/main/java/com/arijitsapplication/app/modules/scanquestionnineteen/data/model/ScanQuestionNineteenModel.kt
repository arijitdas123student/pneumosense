package com.arijitsapplication.app.modules.scanquestionnineteen.`data`.model

import com.arijitsapplication.app.R
import com.arijitsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class ScanQuestionNineteenModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtNO: String? = MyApp.getInstance().resources.getString(R.string.lbl_no2)
  ,
  /**
   * TODO Replace with dynamic value
   */
