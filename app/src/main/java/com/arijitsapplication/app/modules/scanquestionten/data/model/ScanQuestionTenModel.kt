package com.arijitsapplication.app.modules.scanquestionten.`data`.model

import com.arijitsapplication.app.R
import com.arijitsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class ScanQuestionTenModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtUS: String? = MyApp.getInstance().resources.getString(R.string.lbl_us)
  ,
  /**
   * TODO Replace with dynamic value
   */
