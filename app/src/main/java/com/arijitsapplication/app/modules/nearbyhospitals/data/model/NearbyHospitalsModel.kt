package com.arijitsapplication.app.modules.nearbyhospitals.`data`.model

import com.arijitsapplication.app.R
import com.arijitsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class NearbyHospitalsModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtDrPathak: String? = MyApp.getInstance().resources.getString(R.string.lbl_dr_s_pathak)
  ,
  /**
   * TODO Replace with dynamic value
   */
