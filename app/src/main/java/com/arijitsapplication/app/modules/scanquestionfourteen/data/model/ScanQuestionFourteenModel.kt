package com.arijitsapplication.app.modules.scanquestionfourteen.`data`.model

import com.arijitsapplication.app.R
import com.arijitsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class ScanQuestionFourteenModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtFrameTwentySevenOne: String? = MyApp.getInstance().resources.getString(R.string.lbl_no)
  ,
  /**
   * TODO Replace with dynamic value
   */
