package com.arijitsapplication.app.modules.scanquestionthirteen.`data`.model

import com.arijitsapplication.app.R
import com.arijitsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class ScanQuestionThirteenModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var etFrameTwentySevenOneValue: String? = null
)
